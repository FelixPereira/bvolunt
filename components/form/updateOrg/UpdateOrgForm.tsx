...
import GeneralInfo from '@/app/(dashboard)/organizacao/perfil/generalInfo';
import AddressInfo from '@/app/(dashboard)/organizacao/perfil/addressInfo';
import ResetPassword from '@/app/(dashboard)/_components/resetPassword';
